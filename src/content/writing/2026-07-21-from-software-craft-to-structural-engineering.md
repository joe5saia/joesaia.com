...
The foundational text is *Design Patterns: Elements of Reusable Object-Oriented Software*, published in 1994 by Erich Gamma, Richard Helm, Ralph Johnson, and John Vlissides—the Gang of Four. Its [catalog of 23 patterns](https://www.informit.com/articles/article.aspx?p=1327762) divides object-oriented design into three broad kinds of problem:
...
Finally, the empirical case is not as settled as the industry's confidence sometimes suggests. A mapping study of roughly 120 primary studies found that research on the effect of Gang of Four patterns on software quality was controversial ([Ampatzoglou et al., *Journal of Systems and Software*](https://doi.org/10.1016/j.jss.2013.03.063)). A related review found limited evidence that patterns reliably transfer design knowledge or produce better designs ([Budgen, "Design Patterns: Magic or Myth?"](https://doi.org/10.1109/MS.2013.26)). Patterns are accumulated professional knowledge, not mathematical proof. Their effect depends on context, implementation, and the people applying them.
